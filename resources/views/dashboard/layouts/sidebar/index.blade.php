<div id="sidebar" class="active">
    <div class="sidebar-wrapper active">
        ...
        <div class="mt-3 mx-auto" style="width: 90%">
            <div>
                <div class="row ms-1" style="width: 100%;">
                    <div class="col-12 text-center">
                        <a href="/dashboard">
                            <img src="{{ asset('img/jadi-biru.png') }}" alt="Logo" srcset="" width="100px;">
                        </a>
                    </div>
                    <div class="col-12 d-flex justify-content-center">
                        <div class="theme-toggle d-flex gap-2  align-items-center mt-2">
                            ...
                            <div class="form-check form-switch fs-6 ms-2">
        ...
        {{-- Sidebar --}}
        <div class="sidebar-menu mx-auto" style="width: 90%">
            <ul class="menu">

                {{-- Dashboard --}}
                <hr>
                <li class="sidebar-title my-1">Dashboard</li>
                <hr>
                ...
                {{-- Laporan & Logout --}}
                <hr>
                <li class="sidebar-title my-1">Laporan & Logout</li>
                <hr>
